...
class ErrorHandler(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, ignored):
            ...
            await ctx.reply(embed=embed.error(ctx.guild.id, "Please fill all the required arguments"),
            ...
            try:
                await ctx.reply(embed=embed.error(ctx.guild.id, "I don't have the required permissions to do this",
            ...
            print(chalk.red(
                ...
                file=sys.stderr)
            await ctx.reply(embed=embed.error(ctx.guild.id, "An unexpected error occured",
